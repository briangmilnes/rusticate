...
This script:
1. Identifies binaries without logging
2. Adds logging setup after fn main() {
3. Converts println! calls to log! macro calls
4. Ensures analyses/ directory is created
"""
...
'''
    ...
    # Match "fn main() -> Result<()> {" or "fn main() {" with possible whitespace
    ...
    # Now convert println! to log! calls
    # But be careful not to convert:
    # - Debug prints (lines with "DEBUG:")
    # - Error prints (eprintln!)
    # - Prints inside comments
    
    # Simple strategy: replace println! with log! for lines that look like regular output
    # This is safe because log! has the same signature as println!
    new_content = re.sub(r'\bprintln!\s*\(', 'log!(', new_content)
