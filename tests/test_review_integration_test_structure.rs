...
//! Integration tests for rusticate-review-integration-test-structure
...
#[test]
#[serial]
fn test_review_integration_test_structure_on_apas() -> Result<()> {
    let _ctx = TestContext::ensure_apas_at_script_commit("rust/tests/review_integration_test_structure.py")?;
