...
//! Integration tests for rusticate-review-variable-naming
...
#[test]
#[serial]
fn test_review_variable_naming_on_apas() -> Result<()> {
    let _ctx = TestContext::ensure_apas_at_script_commit("rust/src/review_variable_naming.py")?;
